...
.. code-block:: text
    ...
    $ sudo pip install git+https://github.com/F5Networks/f5-openstack-lbaasv2-driver@v8.0.6
...
.. code-block:: bash
    ...
    $ sudo dpkg –i python-f5-openstack-driver_8.0.6-1_1404_all.deb
...
.. code-block:: bash
    ...
    $ curl –L –O https://github.com/F5Networks/f5-openstack-lbaasv2-driver/releases/download/v8.0.6/f5-openstack-lbaasv2-driver-8.0.6-1.el7.noarch.rpm

2. Install the package on the Neutron controller:

.. code-block:: bash

    $ sudo rpm –ivh f5-openstack-lbaasv2-driver-8.0.6-1.el7.noarch.rpm
