...
.. code-block:: text
    ...
    $ sudo pip install git+https://github.com/F5Networks/f5-openstack-lbaasv2-driver@v9.3.0.b1
...
.. code-block:: bash
    ...
    $ curl –L –O https://github.com/F5Networks/f5-openstack-lbaasv2-driver/releases/download/v9.3.0.b1/python-f5-openstack-lbaasv2-driver_9.3.0.b1-1_1404_all.deb

2. Install the package on the Neutron controller:

.. code-block:: bash

    $ sudo dpkg –i python-f5-openstack-lbaasv2-driver_9.3.0.b1-1_1404_all.deb
...
.. code-block:: bash
    ...
    $ curl –L –O https://github.com/F5Networks/f5-openstack-lbaasv2-driver/releases/download/v9.3.0.b1/f5-openstack-lbaasv2-driver-9.3.0.b1-1.el7.noarch.rpm

2. Install the package on the Neutron controller:

.. code-block:: bash

    $ sudo rpm –ivh f5-openstack-lbaasv2-driver-9.3.0.b1-1.el7.noarch.rpm
